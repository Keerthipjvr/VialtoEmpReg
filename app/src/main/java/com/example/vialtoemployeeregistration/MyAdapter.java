...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    private ArrayList name, address, skill, contact, email, location;

    public MyAdapter(Context context, ArrayList name, ArrayList address, ArrayList skill, ArrayList
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView name, address, skill, contact, email, location;
